...
<head>
    ...
    <title>Tasks for <?= htmlspecialchars(dayName($day)) ?></title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bulma@0.9.4/css/bulma.min.css">
</head>
<body>
<main class="container">
    <section class="section">
        <h1 class="title">Tasks for <?= htmlspecialchars(dayName($day)) ?></h1>
        <p class="subtitle">Showing tasks scheduled for day <?= (int)$day ?></p>
